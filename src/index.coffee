...
schema =
	'@context':
		'dc:description': 'Infolis database schema'
		'dc:version': {
			'@value': '2015-03-15'
			'@type': 'xsd:int'
		}
...
mongooseSchemas = {}
for clazz, def of schema
	continue if clazz.indexOf('@') == 0
	mongooseSchemas[clazz] = new Schema def.schema, schema['@context']

module.exports = {
	'@context': schema['@context']
	schema: mongooseSchemas
}
